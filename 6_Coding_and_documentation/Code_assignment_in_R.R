...
#Rewritten version for calculating totals
countries <- c("Belgium", "Spain", "Poland")

#Empty list to store the totals for each country
totals <- list()

for (i in 1:length(countries)) {
  country <- countries[i]
  
  #Calculate the total number of workers for this country
  total <- sum(isco1[[country]], isco2[[country]], isco3[[country]], isco4[[country]], isco5[[country]], isco6[[country]], isco7[[country]], isco8[[country]], isco9[[country]])
  
  #Store the total in the totals list
