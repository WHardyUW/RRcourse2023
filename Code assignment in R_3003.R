...
setwd("C:/Users/ChotC/RR2023/RRcourse2023/6. Coding and documentation")
...
library(readxl)                     
## I re-write this part to be tidier
...
## I re-write this part to be tidier
total_Belgium <- Reduce("+", lapply(isco_list, function(x) x$Belgium))
total_Spain <- Reduce("+", lapply(isco_list, function(x) x$Spain))
total_Poland <- Reduce("+", lapply(isco_list, function(x) x$Poland))
