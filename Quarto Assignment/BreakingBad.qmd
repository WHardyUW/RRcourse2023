...
# Create a bar plot
ax = reviews[["Rotten Tomatoes Score"]].plot(x='Season', kind='bar', title ="Rotten Tomatoes Score", figsize=(15, 10), legend=True, fontsize=12)
...
# Create a bar plot
ax = viewers[["Average Viewership"]].plot(x='Season', kind='bar', title ="Average Viewership", figsize=(15, 10), legend=True, fontsize=12)
