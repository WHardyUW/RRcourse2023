...
# Create a bar plot
ax = viewers[["Average Viewership"]].plot(kind='bar', title ="Average Viewership", figsize=(15, 10), legend=True, fontsize=12)
...
# Create a bar plot
ax = viewers[["Increase"]].plot(kind='bar', title ="Viewership Increase", figsize=(15, 10), legend=True, fontsize=12)

# Set axis labels
ax.set_xlabel("Season", fontsize=12)
ax.set_ylabel("Viewers Increase (in millions, with respect to the previous season)", fontsize=12)
