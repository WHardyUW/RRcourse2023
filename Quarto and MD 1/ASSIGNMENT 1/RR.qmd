...
GOT_VIEWS + scale_fill_manual(values = c("red", "blue", "orange", "green", "purple", "pink", "grey", "black")) + labs(title = "U.S. viewers per Season (avg millions)", x = "Season", y = "Avg_Viewers_Per_Season_mill")
```
