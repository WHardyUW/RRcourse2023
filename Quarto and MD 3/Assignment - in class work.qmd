...
for (x in 1:length(season_data$no_season))

cat( "The Episode", season_data$no_season[x], "Was directed by", season_data$directed_by[x], "and had a premiere on", season_data$premiere_date[x], ".\n\n")
```
