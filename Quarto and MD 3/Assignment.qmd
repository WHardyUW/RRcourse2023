...
### Season 1 summary
```{r}
paste0("Season ", season_no, " of Game of Thrones")
```
 consisted of 10 episodes that aired between April 17 and June 19, 2011 on HBO. The show gathered an average of 2.515 first-day TV viewers in the US, with the number growing from 2.22 to 3.04 million by the end of the season.
