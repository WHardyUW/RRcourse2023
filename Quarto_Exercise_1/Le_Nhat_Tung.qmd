...
```{r}/#| warning = FALSE
setwd("C:/Users/Windows/OneDrive/Learning/WNE/SEM4/RR/Quarto_Exercise_1/")
```
...
@fig-cars display total number over viewers by seasons. We can easly see that the number of viewers
dropped dramatically from season 1 to season 6.
